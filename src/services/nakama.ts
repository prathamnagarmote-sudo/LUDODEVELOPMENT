...
const isForcedRemote = import.meta.env.VITE_NAKAMA_FORCE_REMOTE === 'true';

// On localhost/LAN: ALWAYS connect to local Nakama (localhost:7350) UNLESS forced remote.
